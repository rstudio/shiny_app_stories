...
For a more through explanation of options for scoping (such as default behavior of session-scoped cache,) see the section "Cache scope" in the `bindCache()` documentation (`?shiny::bindCache`). 
