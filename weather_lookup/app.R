...
ui <- fluidPage(
  ...
  plotOutput("prcpPlot"),
  div(span("Stations contributing data", style = "font-size: 1.2em;"),
      span("Click on station to go to its dataset.", style = "font-size: 0.9em; font-style: italic;"),
      uiOutput('station_info', style = "display: flex; flex-wrap: wrap; justify-content: center;"),
